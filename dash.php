...
<body class="grey lighten-3">
  ...
  <header>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark unique-color scrolling-navbar">
      <div class="container-fluid">
        ...
        <a class="navbar-brand waves-effect" href="#" target="_self">
          <strong class="white-text">SpeedBird</strong>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link waves-effect" href="" target="_blank">visit website</a>
            </li>
            <li class="nav-item">
              <a class="nav-link waves-effect" href=""target="_blank">currency</a>
            </li>
          </ul>
    ...
    <!-- Sidebar -->
    <div class="sidebar-fixed position-fixed unique-color">

      <a class="logo-wrapper waves-effect">
        <img src="img/speed.jpg" class="w-50 z-depth-5 rounded mx-auto d-block">
      </a>

      <div class="list-group list-group-flush z-depth-5">
        <a href="#" class="list-group-item active waves-effect">
          <i class="fas fa-compass mr-3"></i>Tours
        </a>
        <a href="#" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-user mr-3"></i>create tour</a>
        <a href="#" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-map mr-3"></i>display tours</a>
        <a href="#" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-table mr-3"></i>manage tours</a>
        <a href="#" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-money-bill-alt mr-3"></i>Bookings</a>
      </div>
  ...
  <main class="pt-5 mx-lg-5">
    <div class="container-fluid mt-5">
      ...
      <div class="card mb-4 wow fadeIn">
        ...
        <!--Card content-->
        <div class="card-body d-sm-flex justify-content-between z-depth-3">
        ...
        <div class="col-md-12 mb-4">
          ...
          <div class="card">
            ...
            <div class="card-body">
					  ...
					  <div id="stepper1" class="bs-stepper">
						<div class="bs-stepper-header">
						  <div class="step" data-target="#test-l-1">
							<button type="button" class="btn btn-sm step-trigger z-depth-5">
							  <span class="bs-stepper-circle">1</span>
							</button>
						  </div>
						  <div class="line"></div>
						  <div class="step" data-target="#test-l-2">
							<button type="button" class="btn step-trigger z-depth-5">
						...
						<div class="bs-stepper-content">
						  <div id="test-l-1" class="content">
							<p class="text-center">
                <!-- Form -->
                <form  id="sidd" action="insert.php" method="POST">
                ...
                <button id="sidd2" type="button" class="btn btn-danger">submit</button>
                </form>
                <!-- ./Form -->
							</div>
						  </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p>
                ...
                Iste est eos, maiores iure explicabo nobis magni illum beatae ab nisi?
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
                Iste est eos, maiores iure explicabo nobis magni illum beatae ab nisi?
              </p>
              <p>
              ...
              <p>
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
                Iste est eos, maiores iure explicabo nobis magni illum beatae 
              </p>
            </div>
  ...
  <footer class="page-footer text-center font-small unique-color mt-4 wow fadeIn">
    ...
    <div class="footer-copyright py-3">
      © 2020 Copyright:
      <a href="" target="_blank"> fabcoders</a>
    </div>
    <!--/.Copyright-->
  ...
  <script type="text/javascript">
    ...
    var f= document.getElementById("sidd");
    ...
    document.getElementById("sidd2").addEventListener("click", function(event)
    {
      f.submit();
    });
    // Bootstrap Stepper initialization
